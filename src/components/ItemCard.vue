<template>
  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
    ...
    <div class="card-wrapper myCard">
      <div id="card-1" @click="infoCard =!infoCard" class="card card-rotating text-center">
        ...
        <div class="faceFront" v-if="infoCard">
          ...
          <div class="card-body">
            ...
            <p class="font-weight-bold blue-text">{{ orignalTitle }}</p>
          </div>
        </div>
        <!-- Front Side -->
...
export default {
  name: 'ItemCard',
  props: [
    'title', 'orignalTitle', 'language', 'vote', 'image', 'overview'
  ],
  data() {
    return {
      store,
